...
import '../../css/buypage/product-options-actions.css'; 
...
function ProductOptions({product}) {
    ...
    const handleaddNote = (e) => {
        setAddNote(e.target.checked);
    };

    const handleGiftWrapChange = (e) => {
        setAddGiftWrap(e.target.checked);
    };

    
    const handleAddToCart = () => {
        // console.log('Add to Cart clicked!', { addNote, addGiftWrap });
